...
GRANT SELECT, INSERT ON data_change_d300 TO app_log_writer;
GRANT SELECT, INSERT ON data_change_d30 TO app_log_writer;
GRANT SELECT, INSERT ON data_change_d7 TO app_log_writer;
GRANT SELECT, INSERT ON data_change_d1 TO app_log_writer;

GRANT SELECT ON data_change_d300 TO app_log_reader;
GRANT SELECT ON data_change_d30 TO app_log_reader;
GRANT SELECT ON data_change_d7 TO app_log_reader;
GRANT SELECT ON data_change_d1 TO app_log_reader;
