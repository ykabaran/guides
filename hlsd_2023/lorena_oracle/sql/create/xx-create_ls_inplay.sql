create user ls_inplay identified by ""
  default tablespace APP_MAIN
  quota unlimited on APP_MAIN
  quota unlimited on APP_MAIN_INDEX;

grant connect, resource to ls_inplay;
alter session set current_schema = ls_inplay;
...
create role ls_inplay_writer;
create role ls_inplay_reader;

GRANT SELECT, INSERT, UPDATE ON fixture TO ls_inplay_writer;
GRANT SELECT, INSERT, UPDATE ON fixture_data TO ls_inplay_writer;
GRANT SELECT, INSERT, UPDATE ON fixture_bet TO ls_inplay_writer;

GRANT SELECT ON fixture TO ls_inplay_reader;
GRANT SELECT ON fixture_data TO ls_inplay_reader;
GRANT SELECT ON fixture_bet TO ls_inplay_reader;
