...
CREATE INDEX ind_game_prize_change_date ON game_prize (change_date) tablespace app_main_index;
...
create table game_prize_redemption (
  ...
  remote_data varchar2(32767), -- transaction ids, balance snapshots, etc
